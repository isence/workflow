...
var prettify = require('gulp-prettify'); //格式化html，解决ejs合并是出现的错位的问题
...
module.exports = function (gulp, config) {
    ...
    if (config.supportREM) {
        postcssOption = [
            postcssAutoprefixer({browsers: ['last 999 versions']}),
            postcssPxtorem({
    ...
    //复制JS /* 0214 lidx */
    function copyJs() {
        return gulp.src(paths.src.js, {base: paths.src.dir}).pipe(gulp.dest(paths.dist.dir));
    }
    //复制font /* 0511 lidx */
    function copyFont() {
        return  gulp.src(paths.src.font, {base: paths.src.dir}).pipe(gulp.dest(paths.dist.dir));
    }
